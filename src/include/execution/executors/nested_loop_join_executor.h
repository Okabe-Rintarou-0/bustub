...
class NestedLoopJoinExecutor : public AbstractExecutor {
   public:
     ...
     * side of join
     * @param right_executor The child executor that produces tuple for the
     * right side of join
     */
     ...
     * @param[out] rid The next tuple RID produced, not used by nested loop
     * join.
    ...
    auto LeftJoinTuple(Tuple* left, Tuple* right) -> Tuple;
