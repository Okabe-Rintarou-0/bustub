...
TEST(ExtendibleHTableTest, BucketPageSampleTest) {
    ...
    page_id_t bucket_page_id = INVALID_PAGE_ID;
    {
        ...
        auto bucket_page =
            guard.AsMut<ExtendibleHTableBucketPage<GenericKey<8>, RID,
                                                   GenericComparator<8>>>();
        bucket_page->Init(10);
    ...
    page_id_t bucket_page_id_4 = INVALID_PAGE_ID;
    {
        ...
        */
        ...
        BasicPageGuard directory_guard =
            bpm->NewPageGuarded(&directory_page_id);
        auto directory_page =
        ...
        auto bucket_page_1 = bucket_guard_1.AsMut<ExtendibleHTableBucketPage<
        ...
        auto bucket_page_2 = bucket_guard_2.AsMut<ExtendibleHTableBucketPage<
            GenericKey<8>, RID, GenericComparator<8>>>();
        bucket_page_2->Init(10);

        BasicPageGuard bucket_guard_3 = bpm->NewPageGuarded(&bucket_page_id_3);
        auto bucket_page_3 = bucket_guard_3.AsMut<ExtendibleHTableBucketPage<
            GenericKey<8>, RID, GenericComparator<8>>>();
        bucket_page_3->Init(10);

        BasicPageGuard bucket_guard_4 = bpm->NewPageGuarded(&bucket_page_id_4);
        auto bucket_page_4 = bucket_guard_4.AsMut<ExtendibleHTableBucketPage<
            GenericKey<8>, RID, GenericComparator<8>>>();
        ...
        */
        ...
        // at this time, we cannot shrink the directory since we have ld = gd =
        // 3
